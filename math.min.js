  ...
  return (function (e) {
        ...
        (r.config = function (e) {
          if (e) {
            if (
              (i.deepExtend(a, e),
              e.precision &&
                r.type.BigNumber.config({ precision: e.precision }),
              t(2)(r, a),
              e.number && e.number.defaultType)
            )
              throw new Error(
                "setting `number.defaultType` is deprecated. Use `number` instead."
              );
            if (e.number && e.number.precision)
              throw new Error(
                "setting `number.precision` is deprecated. Use `precision` instead."
              );
            if (e.matrix && e.matrix.defaultType)
              throw new Error(
                "setting `matrix.defaultType` is deprecated. Use `matrix` instead."
              );
            if (e.matrix && e.matrix["default"])
              throw new Error(
                "setting `matrix.default` is deprecated. Use `matrix` instead."
              );
            if (e.decimals)
              throw new Error(
                "setting `decimals` is deprecated. Use `precision` instead."
              );
          }
          return i.clone(a);
        }),
          (r.create = n);
        var s = t(142).constructor();
        if (
          ("function" != typeof s.prototype.clone &&
            (s.prototype.clone = function () {
              return new s(this);
            }),
          "function" == typeof s.convert)
        )
          throw new Error(
            "Cannot add function convert to BigNumber: function already exists"
          );
        return (
          ...
          (r.type.Unit = t(10)),
          (r.type.Help = t(11)),
          (r.type.ResultSet = t(12)),
          (r.type.BigNumber = s),
          (r.collection = t(13)),
          (r.expression = {}),
          (r.expression.node = t(16)),
          (r.expression.parse = t(14)),
          (r.expression.Parser = t(15)),
          (r.expression.docs = t(17)),
          t(29)(r, a),
          t(30)(r, a),
          t(31)(r, a),
          t(32)(r, a),
          ...
          (r.ifElse = function () {
            throw new Error(
              "Function ifElse is deprecated. Use the conditional operator instead."
            );
          }),
          t(2)(r, a),
          t(18)(r, a),
    ...
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        ...
        function o(e) {
          for (
            var r = e, t = 0 / 0, n = e.times(e), i = e, o = -1, a = 3;
            !r.equals(t);
            a += 2
          )
            (i = i.times(n)),
              (t = r),
              (r = o > 0 ? r.plus(i.div(a)) : r.minus(i.div(a))),
              (o = -o);
          return r;
        }
        function a() {
          var e = f.constructor({ precision: f.precision + 4 }),
            r = new e(4).times(o(new e(1).div(5))).minus(o(new e(1).div(239)));
        ...
        var u = (t(139), t(6)),
          f = e.type.BigNumber,
          c = "bignumber" === r.number;
        (e.pi = c ? a() : Math.PI),
          (e.tau = c ? s() : 2 * Math.PI),
          (e.e = c ? n() : Math.E),
          (e.phi = c ? i() : 1.618033988749895),
          (e.i = new u(0, 1)),
          (e.Infinity = 1 / 0),
          (e.NaN = 0 / 0),
          (e["true"] = !0),
          (e["false"] = !1),
          (e["null"] = null),
          (e.uninitialized = t(140).UNINITIALIZED),
          (e.E = e.e),
          (e.LN2 = c ? new f(2).ln() : Math.LN2),
          (e.LN10 = c ? new f(10).ln() : Math.LN10),
          (e.LOG2E = c ? new f(1).div(new f(2).ln()) : Math.LOG2E),
          (e.LOG10E = c ? new f(1).div(new f(10).ln()) : Math.LOG10E),
          (e.PI = e.pi),
          (e.SQRT1_2 = c ? new f(0.5).sqrt() : Math.SQRT1_2),
          (e.SQRT2 = c ? new f(2).sqrt() : Math.SQRT2),
          (e.version = t(141));
      };
    },
    function (e, r) {
      ...
      (r.clone = function t(e) {
          ...
          for (var t in r)
            if (r.hasOwnProperty(t))
              if (r[t] && r[t].constructor === Object)
                void 0 === e[t] && (e[t] = {}),
                  e[t].constructor === Object ? n(e[t], r[t]) : (e[t] = r[t]);
              else {
        ...
        (r.deepEqual = function (e, t) {
          ...
          if (e instanceof Object) {
            ...
            for (n in e) if (!r.deepEqual(e[n], t[n])) return !1;
            for (n in t) if (!r.deepEqual(e[n], t[n])) return !1;
            return !0;
          }
    ...
    function (e, r) {
      ...
      (r.isNumber = function (e) {
        ...
        (r.format = function (e, t) {
          ...
          switch (
            (t &&
              (t.notation && (n = t.notation),
              r.isNumber(t) ? (i = t) : t.precision && (i = t.precision)),
            n)
          ) {
            case "fixed":
            ...
            case "auto":
              ...
              if (
                (t &&
                  t.exponential &&
                  (void 0 !== t.exponential.lower && (o = t.exponential.lower),
                  void 0 !== t.exponential.upper && (a = t.exponential.upper)),
                0 === e)
              )
                return "0";
              var s,
        ...
        (r.toExponential = function (e, r) {
          return void 0 !== r
            ? e.toExponential(Math.min(r - 1, 20))
            : e.toExponential();
        }),
        ...
        (r.DBL_EPSILON = Number.EPSILON || 2.220446049250313e-16),
        (r.nearlyEqual = function (e, t, n) {
          if (null == n) return e == t;
          if (e == t) return !0;
          if (isNaN(e) || isNaN(t)) return !1;
          if (isFinite(e) && isFinite(t)) {
            var i = Math.abs(e - t);
            return i < r.DBL_EPSILON
              ? !0
              : i <= Math.max(Math.abs(e), Math.abs(t)) * n;
          }
          return !1;
        });
    },
    function (e, r, t) {
      "use strict";
      (r.ArgumentsError = t(143)),
        (r.DimensionError = t(144)),
        (r.IndexError = t(145)),
        (r.UnsupportedTypeError = t(146));
    },
    function (e, r, t) {
      "use strict";
      function n(e, r) {
      ...
      var w, x, y;
      (n.parse = function (e) {
        if (((w = e), (x = -1), (y = ""), !d(w))) return null;
        s(), i();
        var r = f();
        if (r) {
          if ("I" == y || "i" == y)
            return s(), i(), y ? null : new n(0, Number(r));
          i();
          var t = y;
          if ("+" != t && "-" != t) return i(), y ? null : new n(Number(r), 0);
          s(), i();
          var o = f();
          if (o) {
          ...
          return (
            "-" == t && (o = "-" == o[0] ? "+" + o.substring(1) : "-" + o),
            s(),
            i(),
            y ? null : new n(Number(r), Number(o))
          );
        }
        return (r = c()) ? (i(), y ? null : new n(0, Number(r))) : null;
      }),
          ...
          switch (arguments.length) {
            ...
            case 2:
              ...
              if (h(r)) {
                if (
                  (g(t) &&
                    t.hasBase(p.BASE_UNITS.ANGLE) &&
                    (t = t.toNumber("rad")),
                  h(t))
                )
                  return new n(r * Math.cos(t), r * Math.sin(t));
    ...
    function (e, r, t) {
      ...
      function n(e, r, t) {
        ...
        (this.start = null != e ? parseFloat(e) : 0),
          ...
          (this.step = null != t ? parseFloat(t) : 1);
      }
      {
        var i = t(147),
          o = i.number,
      ...
      (n.parse = function (e) {
        ...
        (n.prototype.size = function () {
          var e = 0,
            ...
            i = n - r;
          return (
            o.sign(t) == o.sign(i) ? (e = Math.ceil(i / t)) : 0 == i && (e = 0),
            isNaN(e) && (e = 0),
            [e]
          );
        }),
        ...
        (n.prototype.forEach = function (e) {
          var r = this.start,
            ...
            n = this.end,
            i = 0;
          if (t > 0) for (; n > r; ) e(r, i, this), (r += t), i++;
          else if (0 > t) for (; r > n; ) e(r, i, this), (r += t), i++;
        }),
        ...
        (n.prototype.format = function (e) {
          ...
          return (
            1 != this.step && (r += ":" + o.format(this.step, e)),
            (r += ":" + o.format(this.end, e))
          );
        }),
        (n.prototype.toString = function () {
          return this.format();
    ...
    function (e, r, t) {
      ...
      function n() {
        ...
        for (var e = 0, r = arguments.length; r > e; e++) {
          var t = arguments[e];
          if (t instanceof a) this._ranges.push(t), (this._isScalar = !1);
          else if (c(t)) this._ranges.push(i(t)), (this._isScalar = !1);
          else if (u(t)) this._ranges.push(i([t, t + 1]));
          else {
            var o = t.valueOf();
            if (!c(o))
      ...
      function i(e) {
        ...
        switch (e.length) {
          ...
          default:
            throw new SyntaxError(
              "Wrong number of arguments in Index (2 or 3 expected)"
            );
        }
      }
      var o = t(147),
      ...
      (n.prototype.clone = function () {
        var e = new n();
        return (
          (e._ranges = o.object.clone(this._ranges)),
        ...
        (n.prototype.forEach = function (e) {
          for (var r = 0, t = this._ranges.length; t > r; r++)
            e(this._ranges[r], r, this);
        }),
    ...
    function (e, r, t) {
      ...
      function n(e) {
        ...
        if (e instanceof n) this._data = e.clone()._data;
          ...
          if (null != e)
            throw new TypeError(
              "Unsupported type of data (" + c.types.type(e) + ")"
            );
          this._data = [];
        }
      ...
      function i(e, r) {
        ...
        for (
          var a = r.min(), s = r.max(), u = 0, f = e._size.length;
          f > u;
          u++
        )
          w(a[u], e._size[u]), w(s[u], e._size[u]);
        return new n(o(e._data, r, i.length, 0));
      }
      function o(e, r, t, n) {
        var i = n == t - 1,
          a = r.range(n);
      ...
      function a(e, r, t, i) {
        ...
        if (
          ...
          if (a.length < e._size.length)
            throw new l(a.length, e._size.length, "<");
          if (o.length < a.length) {
            for (var c = 0, m = 0; 1 === a[c] && 1 === o[c]; ) c++;
            for (; 1 === a[c]; ) m++, c++;
            t = h.unsqueeze(t, a.length, m, o);
          }
      ...
      function s(e, r, t, n, i) {
        ...
        a.forEach(
          o
            ...
            : function (o, a) {
                w(o), s(e[o], r, t[a], n, i + 1);
              }
        );
      }
      function u(e, r, t) {
        for (var n = g.clone(e._size), i = !1; n.length < r.length; )
          n.push(0), (i = !0);
      ...
      (n.isMatrix = function (e) {
        ...
        (n.prototype.get = function (e) {
          ...
          if (e.length != this._size.length)
            throw new l(e.length, this._size.length);
        ...
        (n.prototype.set = function (e, r, t) {
          ...
          return (s = e[e.length - 1]), w(s, a.length), (a[s] = r), this;
        }),
        (n.prototype.resize = function (e, r) {
          return (
            (this._size = g.clone(e)),
            (this._data = h.resize(this._data, this._size, r)),
            this
          );
        }),
        (n.prototype.clone = function () {
          var e = new n();
          return (
            (e._data = g.clone(this._data)), (e._size = g.clone(this._size)), e
          );
        }),
        (n.prototype.size = function () {
          return this._size;
        ...
        (n.prototype.map = function (e) {
          var r = this,
            ...
            i = function (t, n) {
              return d(t)
                ? t.map(function (e, r) {
                    return i(e, n.concat(r));
                  })
                : e(t, n, r);
            };
          return (
            (t._data = i(this._data, [])), (t._size = g.clone(this._size)), t
          );
        }),
        (n.prototype.forEach = function (e) {
          var r = this,
    ...
    function (e, r, t) {
      ...
      function l(e) {
        for (var r in A)
          if (A.hasOwnProperty(r) && w.endsWith(e, r)) {
            var t = A[r],
              n = e.length - r.length,
              i = e.substring(0, n),
              o = t.prefixes[i];
            if (void 0 !== o) return { unit: t, prefix: o };
          }
        return null;
      }
      var p,
      ...
      (n.parse = function (e) {
        ...
        (n.prototype._unnormalize = function (e, r) {
          return void 0 == r
            ? e / this.unit.value / this.prefix.value - this.unit.offset
            : e / this.unit.value / r - this.unit.offset;
        }),
        ...
        (n.prototype.to = function (e) {
          var r;
          if (y(e)) {
            if (((r = new n(null, e)), !this.equalBase(r)))
          ...
          if (e instanceof n) {
            ...
            return (
              (r = e.clone()), (r.value = this.value), (r.fixPrefix = !0), r
            );
          }
        ...
        (n.prototype.format = function (e) {
          var r, t;
          if (null === this.value || this.fixPrefix)
            (r = this._unnormalize(this.value)),
              (t = null !== this.value ? d.format(r, e) + " " : ""),
              (t += this.prefix.name + this.unit.name);
          else {
            var n = this._bestPrefix();
            (r = this._unnormalize(this.value, n.value)),
              (t = d.format(r, e) + " "),
              (t += n.name + this.unit.name);
          }
          return t;
        }),
      ...
      var v = {
        ...
        N = {},
        M = { name: "", base: N, value: 1, offset: 0 },
        A = {
          meter: {
            name: "meter",
            base: E.LENGTH,
          ...
          if (
            ...
            for (var i = 0; i < e.examples.length; i++) {
              ...
              (r += "    " + s + "\n"),
                !o ||
                  o instanceof n ||
                  (r += "        " + a.format(o, { precision: 14 }) + "\n");
            }
            r += "\n";
          }
          return (
            e.seealso && (r += "See also: " + e.seealso.join(", ") + "\n"), r
          );
        }),
    ...
    function (e, r, t) {
      ...
      (r.argsToArray = function (e) {
        ...
        (r.deepMap2 = function p(e, r, t) {
          var n, i, o;
          if (c(e))
            if (c(r)) {
              if (e.length != r.length) throw new s(e.length, r.length);
              for (n = [], i = e.length, o = 0; i > o; o++)
                n[o] = p(e[o], r[o], t);
            } else {
              if (r instanceof u) return (n = p(e, r.valueOf(), t)), new u(n);
              for (n = [], i = e.length, o = 0; i > o; o++)
                n[o] = p(e[o], r, t);
            }
          else {
            if (e instanceof u)
              return r instanceof u
                ? ((n = p(e.valueOf(), r.valueOf(), t)), new u(n))
                : ((n = p(e.valueOf(), r, t)), new u(n));
            if (c(r))
              for (n = [], i = r.length, o = 0; i > o; o++)
                n[o] = p(e, r[o], t);
            else {
              if (r instanceof u) return (n = p(e, r.valueOf(), t)), new u(n);
              n = t(e, r);
        ...
        (r.reduce = function (e, r, t) {
          ...
          return e instanceof u ? new u(n(e.valueOf(), r, t)) : n(e, r, t);
        }),
    ...
    function (e, r, t) {
      ...
      function n(e, r) {
        if (1 != arguments.length && 2 != arguments.length)
          throw new F("parse", arguments.length, 1, 2);
        if (((sr = r && r.nodes ? r.nodes : {}), D(e))) return (ur = e), h();
        if (G(e) || e instanceof V)
      ...
      function s() {
        ...
        var e = cr + a();
        if (2 == e.length && or[e])
          return (pr = ir.DELIMITER), (lr = e), o(), void o();
        ...
        if (!p(cr)) {
          ...
          throw k('Syntax error in part "' + lr + '"');
        }
        if (((pr = ir.NUMBER), "." == cr))
          (lr += cr), o(), m(cr) || (pr = ir.UNKNOWN);
        else {
          for (; m(cr); ) (lr += cr), o();
          "." == cr && ((lr += cr), o());
        }
      ...
      function h() {
        ...
        var e = g();
        if ("" != lr)
          throw pr == ir.DELIMITER
            ? P("Unexpected operator " + lr)
            : k('Unexpected part "' + lr + '"');
        return e;
      }
      function g() {
        var e,
        ...
        for ("\n" != lr && ";" != lr && (e = d()); "\n" == lr || ";" == lr; )
          0 == t.length &&
            e &&
            ((r = ";" != lr), t.push({ node: e, visible: r })),
            s(),
            "\n" != lr &&
              ";" != lr &&
              "" != lr &&
              ((e = d()), (r = ";" != lr), t.push({ node: e, visible: r }));
        return t.length > 0 ? new W(t) : e;
      }
      function d() {
        if (pr == ir.SYMBOL && "function" == lr)
          throw k(
      ...
      function w() {
        var e,
          ...
          i = x();
        if ("=" == lr) {
          if (i instanceof tr) return (e = i.name), u(), (t = w()), new Y(e, t);
          if (i instanceof J) return u(), (t = w()), new nr(i, t);
          if (
            i instanceof er &&
            ((n = !0),
            (r = []),
            (e = i.name),
            i.args.forEach(function (e, t) {
              e instanceof tr ? (r[t] = e.name) : (n = !1);
            }),
            n)
          )
            return u(), (t = w()), new $(e, r, t);
      ...
      function x() {
        for (var e = y(); "?" == lr; ) {
          ...
          var t = e,
            n = y();
          if (":" != lr)
            throw k("False part of conditional expression expected");
          (hr = null), u();
          var i = x();
          (e = new Q(t, n, i)), (hr = r);
        }
      ...
      function y() {
        ...
        for (
          ...
          (t = lr), (n = r[t]), u(), (i = [e, v()]), (e = new X(t, n, i));
        return e;
      }
      function v() {
        var e, r, t, n, i;
        for (e = b(), r = { to: "to", in: "to" }; lr in r; )
          (t = lr), (n = r[t]), u(), (i = [e, b()]), (e = new X(t, n, i));
        return e;
      }
      function b() {
        var e,
          r = [];
        if (
          ((e = ":" == lr ? new K("1", "number") : E()), ":" == lr && hr !== mr)
        ) {
          for (r.push(e); ":" == lr && r.length < 3; )
            u(),
              r.push(
                ")" == lr || "]" == lr || "," == lr || "" == lr
                  ? new tr("end")
          ...
          e = 3 == r.length ? new rr(r[0], r[2], r[1]) : new rr(r[0], r[1]);
        }
        return e;
      }
      function E() {
        var e, r, t, n, i;
        for (e = N(), r = { "+": "add", "-": "subtract" }; lr in r; )
          (t = lr), (n = r[t]), u(), (i = [e, N()]), (e = new X(t, n, i));
        return e;
      }
      function N() {
        var e, r, t, n, i;
        if (
          ...
          for (; lr in r; )
            (t = lr), (n = r[t]), u(), (i = [e, M()]), (e = new X(t, n, i));
        return (
          (pr == ir.SYMBOL ||
            ("in" == lr && e instanceof K) ||
            (pr == ir.NUMBER && !(e instanceof K)) ||
            "(" == lr ||
            "[" == lr) &&
            (e = new X("*", "multiply", [e, N()])),
          e
        );
      }
      function M() {
      ...
      function T() {
        var e, r, t, n, i;
        for (e = S(), r = { "!": "factorial", "'": "transpose" }; lr in r; )
          (t = lr), (n = r[t]), s(), (i = [e]), (e = new X(t, n, i));
        return e;
      }
      function S() {
        var e,
        ...
        if (pr == ir.SYMBOL && sr[lr]) {
          if (((e = sr[lr]), s(), "(" == lr)) {
            if (((r = []), f(), s(), ")" != lr))
              for (r.push(x()); "," == lr; ) s(), r.push(x());
            if (")" != lr) throw k("Parenthesis ) expected");
            c(), s();
          }
          return new e(r);
        }
      ...
      function O() {
        var e, r;
        return pr == ir.SYMBOL || (pr == ir.DELIMITER && lr in ar)
          ? ((r = lr), s(), (e = C(r)), (e = U(e)))
          : q();
      }
      function C(e) {
      ...
      function q() {
        ...
        if ('"' == lr) {
          for (r = "", t = ""; "" != cr && ('"' != cr || "\\" == t); )
            (r += cr), (t = cr), o();
          if ((s(), '"' != lr)) throw k('End of string " expected');
      ...
      function B() {
        ...
        if ("[" == lr) {
          if ((f(), s(), "]" != lr)) {
            var i = z();
            if (";" == lr) {
              for (t = 1, r = [i]; ";" == lr; ) s(), (r[t] = z()), t++;
              if ("]" != lr) throw k("End of matrix ] expected");
              c(), s(), (n = r[0].nodes.length);
              for (var o = 1; t > o; o++)
                if (r[o].nodes.length != n)
                  throw P(
      ...
      function _() {
        ...
        if ("(" == lr) {
          if ((f(), s(), (e = w()), ")" != lr))
            throw k("Parenthesis ) expected");
          return c(), s(), e;
        }
        return R();
      }
      function R() {
        throw k("" == lr ? "Unexpected end of expression" : "Value expected");
      }
      function L() {
      ...
      var j = t(147),
        ...
        tr = t(158),
        nr = t(159),
        ir = { NULL: 0, DELIMITER: 1, NUMBER: 2, SYMBOL: 3, UNKNOWN: 4 },
        or = {
          ",": !0,
          "(": !0,
          ")": !0,
    ...
    function (e, r, t) {
      "use strict";
      (r.ArrayNode = t(148)),
        (r.AssignmentNode = t(149)),
        (r.BlockNode = t(150)),
        (r.ConditionalNode = t(151)),
        (r.ConstantNode = t(152)),
        (r.IndexNode = t(154)),
        (r.FunctionAssignmentNode = t(153)),
        (r.FunctionNode = t(156)),
        (r.Node = t(160)),
        (r.OperatorNode = t(155)),
        (r.RangeNode = t(157)),
        (r.SymbolNode = t(158)),
        (r.UpdateNode = t(159));
    },
    function (e, r, t) {
      (r.e = t(164)),
        ...
        (r.transpose = t(248)),
        (r.zeros = t(249)),
        (r.combinations = t(250)),
        (r.factorial = t(251)),
        (r.permutations = t(252)),
        (r.pickRandom = t(253)),
        (r.random = t(254)),
        (r.randomInt = t(255)),
        (r.max = t(256)),
    ...
    function (e, r, t) {
      "use strict";
      var n = t(158),
        i = (t(162).isBoolean, t(140).argsToArray, t(143));
      e.exports = function (e) {
        var r = e.filter;
        (r.transform = function (e, t, o) {
          if (2 !== e.length) throw new i("filter", arguments.length, 2);
          var a,
            s = e[0].compile(t).eval(o);
          if (e[1] instanceof n) a = e[1].compile(t).eval(o);
          else {
            var u = o || {},
              f = e[1].filter(function (e) {
    ...
    function (e, r, t) {
      ...
      {
        var n = t(9);
        t(142), t(7), t(8), t(4).isNumber, Array.isArray;
      }
      e.exports = function (e) {
        function r(e, r, t) {
          var n = function (e, i) {
        ...
        e.map.transform = function (t, i) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError("map", arguments.length, 2);
          if (Array.isArray(t)) return r(t, i, t);
          if (t instanceof n) return new n(r(t.valueOf(), i, t));
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        e.max.transform = function () {
          ...
          if (2 == r.length && a(r[0])) {
            var t = r[1];
            o(t) ? (r[1] = t - 1) : t instanceof n && (r[1] = t.minus(1));
          }
          try {
    ...
    function (e, r, t) {
      "use strict";
      var n = t(161).transform,
        i = (t(162).isBoolean, t(140).argsToArray);
      e.exports = function (e) {
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.help = function (t) {
          if (1 != arguments.length)
            throw new SyntaxError(
              "Wrong number of arguments in function help (" +
                arguments.length +
                " provided, 1 expected)"
            );
          var n = null;
        ...
        e.add = function m(r, t) {
          ...
          if (r instanceof n)
            return (
              u(t)
                ? (t = n.convert(t))
                : (s(t) || null === t) && (t = new n(t ? 1 : 0)),
              t instanceof n ? r.plus(t) : m(r.toNumber(), t)
            );
          if (t instanceof n)
            return (
              u(r)
                ? (r = n.convert(r))
                : (s(r) || null === r) && (r = new n(r ? 1 : 0)),
              r instanceof n ? r.plus(t) : m(r, t.toNumber())
            );
          if (p(r) || p(t)) return a.deepMap2(r, t, m);
          if (f(r) || f(t)) return r + t;
          if (s(r) || null === r) return m(+r, t);
          if (s(t) || null === t) return m(r, +t);
          throw new e.error.UnsupportedTypeError(
            "add",
            e["typeof"](r),
            e["typeof"](t)
          );
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(e, r) {
          ...
          return 0 != t
            ? new o(
                (e.re * r.re + e.im * r.im) / t,
                (e.im * r.re - e.re * r.im) / t
              )
            : new o(0 != e.re ? e.re / 0 : 0, 0 != e.im ? e.im / 0 : 0);
        }
        var n = t(147),
          i = e.type.BigNumber,
          o = t(6),
        ...
        e.divide = function m(t, n) {
          ...
          if (t instanceof i)
            return (
              u(n)
                ? (n = i.convert(n))
                : (f(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? t.div(n) : m(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              u(t)
                ? (t = i.convert(t))
                : (f(t) || null === t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? t.div(n) : m(t, n.toNumber())
            );
          if (l(t) && u(n)) {
            var a = t.clone();
            return (a.value /= n), a;
          ...
          if (f(t) || null === t) return m(+t, n);
          if (f(n) || null === n) return m(t, +n);
          throw new e.error.UnsupportedTypeError(
            "divide",
            e["typeof"](t),
            e["typeof"](n)
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        (e.dotDivide = function (t, n) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError("dotDivide", arguments.length, 2);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        (e.dotMultiply = function (t, n) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError(
              "dotMultiply",
              arguments.length,
              2
            );
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        (e.dotPow = function (t, n) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError("dotPow", arguments.length, 2);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.fix = function c(r) {
          ...
          if (u(r))
            return new i(
              r.re > 0 ? Math.floor(r.re) : Math.ceil(r.re),
              r.im > 0 ? Math.floor(r.im) : Math.ceil(r.im)
            );
        ...
        e.gcd = function c() {
          ...
          if (2 == arguments.length) {
            if (a(n) && a(l)) {
              ...
              for (; 0 != l; ) (t = n % l), (n = l), (l = t);
              return 0 > n ? -n : n;
            }
            if (f(n) || f(l)) return o.deepMap2(n, l, c);
            if (n instanceof i)
              return (
                a(l)
                  ? (l = i.convert(l))
                  : (s(l) || null === l) && (l = new i(l ? 1 : 0)),
                l instanceof i ? r(n, l) : c(n.toNumber(), l)
              );
            if (l instanceof i)
              return (
                a(n)
                  ? (n = i.convert(n))
                  : (s(n) || null === n) && (n = new i(n ? 1 : 0)),
                n instanceof i ? r(n, l) : c(n.toNumber(), l)
              );
            if (s(n) || null === n) return c(+n, l);
            if (s(l) || null === l) return c(n, +l);
            throw new e.error.UnsupportedTypeError(
              "gcd",
              e["typeof"](n),
              e["typeof"](l)
          ...
          if (arguments.length > 2) {
            for (var p = 1; p < arguments.length; p++) n = c(n, arguments[p]);
            return n;
          }
        ...
        e.lcm = function c() {
          ...
          if (2 == arguments.length) {
            if (a(n) && a(l)) {
              ...
              if (0 == n || 0 == l) return 0;
              for (var p = n * l; 0 != l; ) (t = l), (l = n % t), (n = t);
              return Math.abs(p / n);
            }
            if (f(n) || f(l)) return o.deepMap2(n, l, c);
            if (n instanceof i)
          ...
          if (arguments.length > 2) {
            for (var m = 1; m < arguments.length; m++) n = c(n, arguments[m]);
            return n;
          }
      ...
      e.exports = function (e) {
        ...
        e.log = function c(r, t) {
          if (1 == arguments.length) {
            ...
            if (u(r))
              return new i(
                Math.log(Math.sqrt(r.re * r.re + r.im * r.im)),
                Math.atan2(r.im, r.re)
              );
            if (r instanceof n)
              return r.isNegative() ? c(r.toNumber()) : r.ln();
            if (f(r)) return o.deepMap(r, c);
            if (s(r) || null === r) return c(+r);
        ...
        e.log10 = function c(r) {
          ...
          if (u(r))
            return new i(
              ...
              Math.atan2(r.im, r.re) / Math.LN10
            );
          if (f(r)) return o.deepMap(r, c);
          if (s(r) || null === r) return c(+r);
          ...
          if (t instanceof i)
            return (
              a(n)
                ? (n = i.convert(n))
                : (s(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? (n.isZero() ? t : t.mod(n)) : f(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              a(t)
                ? (t = i.convert(t))
                : (s(t) || null === t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? (n.isZero() ? t : t.mod(n)) : f(t, n.toNumber())
            );
          if (u(t) || u(n)) return o.deepMap2(t, n, f);
          if (s(t) || null === t) return f(+t, n);
          if (s(n) || null === n) return f(t, +n);
          throw new e.error.UnsupportedTypeError(
            "mod",
            e["typeof"](t),
            e["typeof"](n)
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(r, t) {
          for (
            var n = [], i = r.length, o = t[0].length, a = r[0].length, s = 0;
            i > s;
            s++
          ) {
            n[s] = [];
        ...
        function a(e, r) {
          return 0 == e.im
            ? 0 == r.im
              ...
              : 0 == r.re
              ? new f(0, e.re * r.im)
              : new f(e.re * r.re, e.re * r.im)
            : 0 == e.re
            ? 0 == r.im
              ? new f(0, e.im * r.re)
              : 0 == r.re
              ? new f(-e.im * r.im, 0)
              : new f(-e.im * r.im, e.im * r.re)
            : 0 == r.im
            ? new f(e.re * r.re, e.im * r.re)
            : 0 == r.re
            ? new f(-e.im * r.im, e.re * r.im)
            : new f(e.re * r.re - e.im * r.im, e.re * r.im + e.im * r.re);
        }
        var s = t(147),
          u = e.type.BigNumber,
          f = t(6),
        ...
        e.multiply = function y(t, s) {
          ...
          if (h(t)) {
            ...
            if (x(s))
              return (
                (l = s.clone()),
                (l.value = null === l.value ? l._normalize(t) : l.value * t),
                l
              );
          }
          if (d(t)) {
          ...
          if (t instanceof u)
            return (
              h(s)
                ? (s = u.convert(s))
                : (g(s) || null === s) && (s = new u(s ? 1 : 0)),
              s instanceof u ? t.times(s) : y(t.toNumber(), s)
            );
          if (s instanceof u)
            return (
              h(t)
                ? (t = u.convert(t))
                : (g(t) || null === t) && (t = new u(t ? 1 : 0)),
              t instanceof u ? t.times(s) : y(t, s.toNumber())
            );
          if (x(t) && h(s))
            return (
              (l = t.clone()),
              (l.value = null === l.value ? l._normalize(s) : l.value * s),
              l
            );
          if (w(t)) {
            if (w(s)) {
              ...
              if (1 == v.length) {
                if (1 == b.length) {
                  if (v[0] != b[0])
                    throw new RangeError(
                      "Dimension mismatch in multiplication. Length of A must match length of B (A is " +
                        v[0] +
                        ", B is " +
                        b[0] +
                        v[0] +
                ...
                if (2 == b.length) {
                  if (v[0] != b[0])
                    throw new RangeError(
                      "Dimension mismatch in multiplication. Length of A must match rows of B (A is " +
                        v[0] +
                        ", B is " +
                        b[0] +
                        "x" +
                ...
                throw new Error(
                  "Can only multiply a 1 or 2 dimensional matrix (B has " +
                    b.length +
                    " dimensions)"
                );
              }
              if (2 == v.length) {
                if (1 == b.length) {
                  if (v[1] != b[0])
                    throw new RangeError(
                      "Dimension mismatch in multiplication. Columns of A must match length of B (A is " +
                        v[0] +
                        "x" +
                        v[0] +
                        ", B is " +
                ...
                if (2 == b.length) {
                  if (v[1] != b[0])
                    throw new RangeError(
                      "Dimension mismatch in multiplication. Columns of A must match rows of B (A is " +
                        v[0] +
                        "x" +
                        v[1] +
                        ", B is " +
              ...
              throw new Error(
                "Can only multiply a 1 or 2 dimensional matrix (A has " +
                  v.length +
                  " dimensions)"
              );
            }
            return s instanceof c
              ? ((l = y(t, s.valueOf())), w(l) ? new c(l) : l)
              : p.deepMap2(t, s, y);
          }
          if (t instanceof c)
            return s instanceof c
              ? ((l = y(t.valueOf(), s.valueOf())), w(l) ? new c(l) : l)
              : ((l = y(t.valueOf(), s)), w(l) ? new c(l) : l);
          if (w(s)) return p.deepMap2(t, s, y);
          if (s instanceof c) return new c(p.deepMap2(t, s.valueOf(), y));
          if (g(t) || null === t) return y(+t, s);
          if (g(s) || null === s) return y(t, +s);
          throw new e.error.UnsupportedTypeError(
            "multiply",
            e["typeof"](t),
            e["typeof"](s)
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        var r = t(147),
          ...
          o = t(6),
          a = t(9),
          s = (t(13), r.number.isNumber),
          u = r["boolean"].isBoolean,
          f = o.isComplex,
          c = Array.isArray;
        e.norm = function l(r, t) {
          if (arguments.length < 1 || arguments.length > 2)
            throw new e.error.ArgumentsError("abs", arguments.length, 1, 2);
            ...
            if (2 == o.length) {
              if (1 == t) {
                for (var m = [], h = 0; h < r.length; h++)
                  for (var g = r[h], d = 0; d < g.length; d++)
                    m[d] = e.add(m[d] || 0, e.abs(g[d]));
                return e.max(m);
              }
              if (t == Number.POSITIVE_INFINITY || "inf" === t) {
                for (var p = 0, h = 0; h < r.length; h++) {
                  for (var w = 0, g = r[h], d = 0; d < g.length; d++)
                    w = e.add(w, e.abs(g[d]));
                  e.larger(w, p) && (p = w);
                }
                return p;
        ...
        e.nthRoot = function l(t, o) {
          ...
          switch (arguments.length) {
            case 1:
              ...
              if (c(t)) return s.deepMap(x, l);
              if (f(t) || null === t) return l(+t);
              break;
            case 2:
              if (u(t)) {
                if (u(o)) return r(t, o);
                if (o instanceof a)
                  return (
                    (t = a.convert(t)),
                    t instanceof a ? i(t, o) : r(t, o.toNumber())
                  );
              } else {
                if (t instanceof a)
                  return (
                    u(o) && (o = a.convert(o)),
                    o instanceof a ? i(t, o) : r(t.toNumber(), o)
                  );
                if (c(t) && !c(o)) return s.deepMap2(t, o, l);
              }
              if (f(t) || null === t) return l(+t, o);
              if (f(o) || null === o) return l(t, +o);
              break;
            default:
              throw new e.error.ArgumentsError(
                "nthRoot",
          ...
          if (f(x) || null === x)
            return 2 == arguments.length ? l(+x, n) : l(+x);
          throw new e.error.UnsupportedTypeError(
            "nthRoot",
            e["typeof"](t),
            e["typeof"](o)
      ...
      e.exports = function (e) {
        ...
        e.pow = function m(t, n) {
          ...
          if (t instanceof i)
            return (
              u(n)
                ...
                : (f(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i
                ? n.isInteger() && !t.isNegative()
                  ? t.pow(n)
                  : m(t.toNumber(), n.toNumber())
                : m(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
          ...
          if (c(t)) {
            if (!u(n) || !l(n) || 0 > n)
              throw new TypeError(
                "For A^b, b must be a positive integer (value is " + n + ")"
              );
            var h = s.size(t);
            if (2 != h.length)
              throw new Error(
            ...
            for (var g = e.eye(h[0]).valueOf(), d = t; n >= 1; )
              1 == (1 & n) && (g = e.multiply(d, g)),
                (n >>= 1),
                (d = e.multiply(d, d));
            return g;
          }
      ...
      e.exports = function (e) {
        ...
        e.round = function p(t, n) {
          ...
          if (void 0 == n) {
            ...
            if (f(t) || null === t) return Math.round(t);
            throw new e.error.UnsupportedTypeError("round", e["typeof"](t));
          }
          if (!s(n) || !u(n)) {
            if (!(n instanceof i)) {
              if (f(n) || null === t) return p(t, +n);
              throw new TypeError(
      ...
      e.exports = function (e) {
        ...
        e.sqrt = function c(r) {
          ...
          if (u(r)) {
            var t,
              l,
              p = Math.sqrt(r.re * r.re + r.im * r.im);
            return (
              (t =
                r.re >= 0
                  ? 0.5 * Math.sqrt(2 * (p + r.re))
                  : Math.abs(r.im) / Math.sqrt(2 * (p - r.re))),
              (l =
                r.re <= 0
                  ? 0.5 * Math.sqrt(2 * (p - r.re))
                  : Math.abs(r.im) / Math.sqrt(2 * (p + r.re))),
              r.im >= 0 ? new i(t, l) : new i(t, -l)
            );
          }
          if (r instanceof n)
            return r.isNegative() ? c(r.toNumber()) : r.sqrt();
          if (f(r)) return o.deepMap(r, c);
          if (s(r) || null === r) return c(+r);
          ...
          if (r instanceof n)
            return (
              u(t)
                ? (t = n.convert(t))
                : (s(t) || null === t) && (t = new n(t ? 1 : 0)),
              t instanceof n ? r.minus(t) : p(r.toNumber(), t)
            );
          if (t instanceof n)
            return (
              u(r)
                ? (r = n.convert(r))
                : (s(r) || null === r) && (r = new n(r ? 1 : 0)),
              r instanceof n ? r.minus(t) : p(r, t.toNumber())
            );
          if (c(r) && c(t)) {
            if (null == r.value)
              throw new Error(
    ...
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        ...
        (e.unaryMinus = function h(t) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("unaryMinus", arguments.length, 1);
          if (u(t)) return -t;
          ...
          if (m(t)) return s.deepMap(t, h);
          if (f(t) || c(t) || null === t)
            return "bignumber" == r.number ? new i(-t) : -t;
          throw new e.error.UnsupportedTypeError("unaryMinus", e["typeof"](t));
        }),
          (e.unary = function () {
            throw new Error(
              "Function unary is deprecated. Use unaryMinus instead."
            );
          });
      };
    },
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        ...
        e.unaryPlus = function h(t) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("unaryPlus", arguments.length, 1);
          if (u(t)) return t;
    ...
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        function n(e, t) {
          for (var n, i, o, s = 0, u = 1, f = 1, c = 0; t; )
            (i = Math.floor(e / t)),
              (o = e % t),
              (n = s),
              (s = u - i * s),
          ...
          var l;
          return (
            (l = 0 > e ? [-e, -u, -c] : [e, e ? u : 0, c]),
            "array" === r.matrix ? l : new a(l)
          );
        }
        function i(e, t) {
          for (
          ...
          if (2 == arguments.length) {
            ...
            if (r instanceof s)
              return (
                u(t)
                  ? (t = s.convert(t))
                  : (f(t) || null === t) && (t = new s(t ? 1 : 0)),
                t instanceof s ? i(r, t) : l(r.toNumber(), t)
              );
            if (t instanceof s)
              return (
                u(r)
                  ? (r = s.convert(r))
                  : (f(r) || null === r) && (r = new s(r ? 1 : 0)),
                r instanceof s ? i(r, t) : l(r.toNumber(), t)
              );
            if (f(r) || null === r) return l(+r, t);
            if (f(t) || null === t) return l(r, +t);
            throw new e.error.UnsupportedTypeError(
              "xgcd",
              e["typeof"](r),
              e["typeof"](t)
    ...
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        ...
        e.compare = function g(t, n) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError("compare", arguments.length, 2);
          if (u(t) && u(n)) return f(t, n, r.epsilon) ? 0 : t > n ? 1 : -1;
          if (t instanceof i)
            return (
              u(n)
                ? (n = i.convert(n))
                : (c(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? new i(t.cmp(n)) : g(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              u(t)
                ? (t = i.convert(t))
                : (c(t) || null === t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? new i(t.cmp(n)) : g(t, n.toNumber())
            );
          if (m(t) && m(n)) {
            if (!t.equalBase(n))
          ...
          if (c(t) || null === t) return g(+t, n);
          if (c(n) || null === n) return g(t, +n);
          if (p(t) || p(n))
            throw new TypeError(
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(t, n) {
          if (o(t)) {
            if (o(n)) {
              ...
              for (var a = 0; i > a; a++) if (!r(t[a], n[a])) return !1;
              return !0;
            }
            return !1;
          }
          return o(n) ? !1 : e.equal(t, n);
        }
        var n = t(13),
          i = n.isCollection,
          o = Array.isArray;
        e.deepEqual = function (t, n) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError("deepEqual", arguments.length, 2);
          return i(t) || i(n) ? r(t.valueOf(), n.valueOf()) : e.equal(t, n);
        };
      };
    },
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        ...
        e.equal = function g(t, n) {
          ...
          if (p(t)) {
            ...
            if (p(n))
              return f(t.re, n.re, r.epsilon) && f(t.im, n.im, r.epsilon);
          }
          if (t instanceof i)
            return (
              u(n) ? (n = i.convert(n)) : c(n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? t.eq(n) : g(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              u(t) ? (t = i.convert(t)) : c(t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? t.eq(n) : g(t, n.toNumber())
            );
          if (m(t) && m(n)) {
            if (!t.equalBase(n))
              throw new Error("Cannot compare units with different base");
          ...
          if (t instanceof i)
            return (
              u(n)
                ? (n = i.convert(n))
                : (c(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? t.gt(n) : g(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              u(t)
                ? (t = i.convert(t))
                : (c(t) || null === t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? t.gt(n) : g(t, n.toNumber())
            );
          if (m(t) && m(n)) {
            if (!t.equalBase(n))
              throw new Error("Cannot compare units with different base");
          ...
          if (t instanceof i)
            return (
              u(n)
                ? (n = i.convert(n))
                : (c(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? t.gte(n) : g(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              u(t)
                ? (t = i.convert(t))
                : (c(t) || null === t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? t.gte(n) : g(t, n.toNumber())
            );
          if (m(t) && m(n)) {
            if (!t.equalBase(n))
              throw new Error("Cannot compare units with different base");
          ...
          if (t instanceof i)
            return (
              u(n)
                ? (n = i.convert(n))
                : (c(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? t.lt(n) : g(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              u(t)
                ? (t = i.convert(t))
                : (c(t) || null === t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? t.lt(n) : g(t, n.toNumber())
            );
          if (m(t) && m(n)) {
            if (!t.equalBase(n))
              throw new Error("Cannot compare units with different base");
          ...
          if (t instanceof i)
            return (
              u(n)
                ? (n = i.convert(n))
                : (c(n) || null === n) && (n = new i(n ? 1 : 0)),
              n instanceof i ? t.lte(n) : g(t.toNumber(), n)
            );
          if (n instanceof i)
            return (
              u(t)
                ? (t = i.convert(t))
                : (c(t) || null === t) && (t = new i(t ? 1 : 0)),
              t instanceof i ? t.lte(n) : g(t, n.toNumber())
            );
          if (m(t) && m(n)) {
            if (!t.equalBase(n))
              throw new Error("Cannot compare units with different base");
          ...
          switch (arguments.length) {
            ...
            case 1:
              ...
              if (u(r)) {
                ...
                if (t) return t;
                throw new SyntaxError(
                  'String "' + r + '" is no valid complex number'
                );
              }
              ...
              throw new TypeError(
                "Two numbers, single string or an fitting object expected in function complex"
              );
            case 2:
              var l = arguments[0],
                p = arguments[1];
              if (
                (l instanceof n && (l = l.toNumber()),
                p instanceof n && (p = p.toNumber()),
                s(l) && s(p))
              )
                return new i(l, p);
              throw new TypeError(
        ...
        e.number = function c(r, t) {
          switch (arguments.length) {
            ...
            case 1:
              ...
              if (f(r)) {
                var l = Number(r);
                if ((isNaN(l) && (l = Number(r.valueOf())), isNaN(l)))
                  throw new SyntaxError(r.toString() + " is no valid number");
                return l;
              }
            ...
            case 2:
              if ((r instanceof i && f(t)) || t instanceof i)
                return r.toNumber(t);
              throw new e.error.UnsupportedTypeError(
                "number",
                e["typeof"](r),
        ...
        e.unit = function u(r) {
          switch (arguments.length) {
            case 1:
              ...
              throw new TypeError(
                "A string or a number and string expected in function unit"
              );
            case 2:
              return arguments[0] instanceof n
                ? new i(arguments[0].toNumber(), arguments[1])
                : new i(arguments[0], arguments[1]);
            default:
      ...
      e.exports = function (e) {
        function r(t, n, i, o) {
          if (i > o) {
            if (t.length != n.length)
              throw new e.error.DimensionError(t.length, n.length);
        ...
        e.concat = function () {
          ...
          for (t = 0; a > t; t++) {
            ...
            if (
              (g instanceof o && (m = !0),
              t == a - 1 && (f(g) || g instanceof i))
            ) {
              if (((n = p), (p = g.valueOf()), !c(p)))
                throw new TypeError("Integer number expected for dimension");
              if (0 > p) throw new e.error.IndexError(p);
              if (t > 0 && p > n) throw new e.error.IndexError(p, n + 1);
            } else {
              if (!l(g))
                throw new e.error.UnsupportedTypeError(
                  "concat",
              ...
              var d = s.clone(g).valueOf(),
                w = u.size(g.valueOf());
              if (((h[t] = d), (n = p), (p = w.length - 1), t > 0 && p != n))
                throw new e.error.DimensionError(n + 1, p + 1);
            }
          }
          if (0 == h.length)
            throw new SyntaxError("At least one matrix expected");
          for (var x = h.shift(); h.length; ) x = r(x, h.shift(), p, 0);
          return m ? new o(x) : x;
        };
      };
    },
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(r, t) {
          var i = n.size(r),
            o = n.size(t);
          if (1 != i.length || 1 != o.length || 3 != i[0] || 3 != o[0])
            throw new RangeError(
          ...
          return [
            e.subtract(e.multiply(r[1], t[2]), e.multiply(r[2], t[1])),
            e.subtract(e.multiply(r[2], t[0]), e.multiply(r[0], t[2])),
            e.subtract(e.multiply(r[0], t[1]), e.multiply(r[1], t[0])),
          ];
        }
        var n = t(140),
          i = t(9);
        e.cross = function (t, n) {
          if (t instanceof i) {
            if (n instanceof i) return new i(r(t.toArray(), n.toArray()));
            if (Array.isArray(n)) return new i(r(t.toArray(), n));
          } else if (Array.isArray(t)) {
            if (n instanceof i) return new i(r(t, n.toArray()));
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(r, t) {
          ...
          if (2 == t)
            return e.subtract(
              e.multiply(r[0][0], r[1][1]),
              e.multiply(r[1][0], r[0][1])
            );
          for (
            var n = function (r) {
                var t,
                ...
                for (t = 0; t < r.length; t++) {
                  for (
                    i[t] = new Array(r.length),
                      i[t][t] = e.unaryMinus(o),
                      n = 0;
                    t > n;
                    n++
                  )
            ...
            i = e.multiply(n(i), r);
          return t % 2 == 0 ? e.unaryMinus(i[0][0]) : i[0][0];
        }
        var n = t(147),
          i = t(9),
          o = n.object,
        ...
        e.det = function (t) {
          ...
          switch (
            ...
            case 1:
              ...
              throw new RangeError(
                "Matrix must be square (size: " + a.format(n) + ")"
              );
            case 2:
              var s = n[0],
                u = n[1];
            ...
            default:
              throw new RangeError(
                "Matrix must be two dimensional (size: " + a.format(n) + ")"
              );
          }
        };
      };
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.diag = function (r, t) {
          ...
          if (t) {
            if ((t instanceof n && (t = t.toNumber()), !s(t) || !u(t)))
              throw new TypeError(
          ...
          if (r instanceof i) m = !1;
            ...
            if (!a(r))
              throw new TypeError(
                "First parameter in function diag must be a Matrix or Array"
              );
            (r = new i(r)), (m = !0);
          }
          var d = r.size();
          switch (d.length) {
            case 1:
              c = r.valueOf();
              var w = new i(),
                x = c[0] instanceof n ? new n(0) : 0;
              for (
                w.resize([c.length + g, c.length + h], x),
                  f = w.valueOf(),
                  p = c.length,
                  l = 0;
                p > l;
                ...
                f[l + g][l + h] = o.clone(c[l]);
              return m ? w.valueOf() : w;
            case 2:
              for (
                c = [],
                  f = r.valueOf(),
                  p = Math.min(d[0] - g, d[1] - h),
                  l = 0;
                p > l;
                l++
              )
                c[l] = o.clone(f[l + g][l + h]);
              return m ? c : new i(c);
            default:
              throw new RangeError(
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(r, t) {
          ...
          if (i[0] != o[0])
            throw new RangeError(
              "Vectors must have equal length (" + i[0] + " != " + o[0] + ")"
            );
          if (0 == a)
            throw new RangeError(
              "Cannot calculate the dot product of empty vectors"
            );
          for (var s = 0, u = 0; a > u; u++)
            s = e.add(s, e.multiply(r[u], t[u]));
          return s;
        }
        var n = t(140),
          i = t(9);
      ...
      e.exports = function (e, r) {
        ...
        e.eye = function (t) {
          ...
          if (1 == n.length) n[1] = n[0];
            ...
            throw new e.error.ArgumentsError("eye", n.length, 0, 2);
          var l = n[0],
            p = n[1];
          if (
            (l instanceof i && (l = l.toNumber()),
            p instanceof i && (p = p.toNumber()),
            !s(l) || !u(l) || 1 > l)
          )
            throw new Error(
          ...
          var h = new o(),
            ...
            d = m ? new i(0) : 0;
          h.resize(n, d);
          for (var w = e.min(n), x = h.valueOf(), y = 0; w > y; y++)
            x[y][y] = g;
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.flatten = function (r) {
          if (1 !== arguments.length)
            throw new e.error.ArgumentsError("flatten", arguments.length, 1);
          if (r instanceof n) {
            var t = i.clone(r.toArray()),
              s = o.flatten(t);
            return new n(s);
          }
      ...
      e.exports = function (e) {
        function r(r, t, n) {
          ...
          if (2 == t) {
            ...
            if (0 == f)
              throw Error("Cannot calculate inverse, determinant is zero");
            return [
              [e.divide(r[1][1], f), e.divide(e.unaryMinus(r[0][1]), f)],
              [e.divide(e.unaryMinus(r[1][0]), f), e.divide(r[0][0], f)],
            ];
          }
          var c = r.concat();
          ...
          for (var l = e.eye(t).valueOf(), p = 0; n > p; p++) {
            ...
            for (i = 0; t > i; i++) {
              ...
              if (i != p) {
                if (0 != g[p]) {
                  for (
                    a = e.divide(e.unaryMinus(g[p]), m[p]), o = p;
                    n > o;
                    o++
                  )
                    g[o] = e.add(g[o], e.multiply(a, m[o]));
                  for (o = 0; n > o; o++)
        ...
        e.inv = function (t) {
          ...
          switch (n.length) {
            ...
            case 1:
              if (1 == n[0])
                return t instanceof o
                  ? new o([e.divide(1, t.valueOf()[0])])
                  : [e.divide(1, t[0])];
              throw new RangeError(
                "Matrix must be square (size: " + i.format(n) + ")"
              );
            case 2:
              var a = n[0],
                s = n[1];
            ...
            default:
              throw new RangeError(
                "Matrix must be two dimensional (size: " + i.format(n) + ")"
              );
          }
        };
      };
    ...
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        function n(e, r, t) {
          var n = [],
            i = e;
          if (t > 0) for (; r > i; ) n.push(i), (i += t);
          else if (0 > t) for (; i > r; ) n.push(i), (i += t);
          return n;
        }
        function i(e, r, t) {
          var n = [],
        ...
        function o(e, r, t) {
          var n = [],
            i = e.clone(),
            o = new f(0);
          if (t.gt(o)) for (; i.lt(r); ) n.push(i), (i = i.plus(t));
          else if (t.lt(o)) for (; i.gt(r); ) n.push(i), (i = i.plus(t));
          return n;
        }
        function a(e, r, t) {
          var n = [],
            i = e.clone(),
            o = new f(0);
          if (t.gt(o)) for (; i.lte(r); ) n.push(i), (i = i.plus(t));
          else if (t.lt(o)) for (; i.gte(r); ) n.push(i), (i = i.plus(t));
          return n;
        }
        function s(e) {
          var t = e.split(":"),
            n = null;
          if ("bignumber" === r.number)
            try {
              n = t.map(function (e) {
                return new f(e);
              });
        ...
        e.range = function () {
          ...
          switch ((l(g[g.length - 1]) && (d = g.pop() ? !0 : !1), g.length)) {
            case 1:
              ...
              if (!w)
                throw new SyntaxError(
                  'String "' + g[0] + '" is no valid range'
                );
              (t = w.start), (u = w.end), (h = w.step);
              break;
            case 2:
              (t = g[0]), (u = g[1]), (h = 1);
              break;
          ...
          if (!(m(t) || t instanceof f))
            throw new TypeError("Parameter start must be a number");
          if (!(m(u) || u instanceof f))
            throw new TypeError("Parameter end must be a number");
          if (!(m(h) || h instanceof f))
            throw new TypeError("Parameter step must be a number");
          if (t instanceof f || u instanceof f || h instanceof f) {
            var x = !0;
            t instanceof f || (t = f.convert(t)),
              u instanceof f || (u = f.convert(u)),
              h instanceof f || (h = f.convert(h)),
              (t instanceof f && u instanceof f && h instanceof f) ||
                ((x = !1),
                t instanceof f && (t = t.toNumber()),
                u instanceof f && (u = u.toNumber()),
                h instanceof f && (h = h.toNumber()));
          }
          var y = x ? (d ? a : o) : d ? i : n,
            v = y(t, u, h);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        ...
        e.resize = function (t, i, f) {
          ...
          if (
            (t instanceof a && (t = t.valueOf()),
            i instanceof a && (i = i.valueOf()),
            i.length &&
              i[0] instanceof o &&
              (i = i.map(function (e) {
    ...
    function (e, r, t) {
      ...
      e.exports = function (e, r) {
        ...
        e.size = function (t) {
          ...
          if (f(t) || p(t) || m(t) || c(t) || null == t || t instanceof i)
            return n ? [] : new s([]);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(r, t) {
          var i, o;
          if (l(r)) return (i = new s(r)), (o = i.subset(t)), o && o.valueOf();
        ...
        function n(r, t) {
          ...
          if (1 != t.size().length)
            throw new e.error.DimensionError(t.size().length, 1);
          var n = r.length;
        ...
        function i(r, t, n, i) {
          var a;
          if (l(r))
            return (a = new s(e.clone(r))), a.subset(t, n, i), a.valueOf();
        ...
        function o(r, t, n, i) {
          ...
          var o = t.range(0),
            a = o.size()[0];
          if (a != n.length)
            throw new e.error.DimensionError(o.size()[0], n.length);
          var s = r.length;
        ...
        e.transpose = function (r) {
          ...
          switch (t.length) {
            ...
            case 2:
              ...
              if (0 === s)
                throw new RangeError(
                  "Cannot transpose a 2D matrix with no rows(size: " +
                    o.format(t) +
                    ")"
                );
              for (var m = 0; s > m; m++) {
      ...
      e.exports = function (e) {
        ...
        e.factorial = function c(r) {
          ...
          if (o(r)) {
            if (!s(r) || 0 > r)
              throw new TypeError(
                "Positive integer value expected in function factorial"
              );
          ...
          if (r instanceof n) {
            ...
            var p = new n(1);
            for (t = r.minus(p), l = r; t.gt(p); )
              (l = l.times(t)), (t = t.minus(p));
      ...
      e.exports = function (e) {
        ...
        e.permutations = function (r, t) {
          ...
          if (r instanceof n) {
            ...
            if (((t = n.convert(t)), !(t instanceof n && a(r) && a(t))))
              throw new TypeError(
                "Positive integer value expected in function permutations"
              );
            if (t.gt(r))
            ...
            for (s = new n(1), u = r.minus(t).plus(1); u.lte(r); u = u.plus(1))
              s = s.times(u);
            return s;
          }
          throw new e.error.UnsupportedTypeError(
      ...
      e.exports = function (e) {
        ...
        e.combinations = function (r, t) {
          ...
          if (i(r)) {
            if (!o(r) || 0 > r)
              throw new TypeError(
                "Positive integer value enpected in function combinations"
              );
            if (t > r) throw new TypeError("k must be less than or equal to n");
            for (s = Math.max(t, r - t), u = 1, f = 1; r - s >= f; f++)
              u = (u * (s + f)) / f;
            return u;
          }
          if (r instanceof n) {
            ...
            for (
              ...
              u = u.times(s.plus(f)).dividedBy(f);
            return u;
          }
          throw new e.error.UnsupportedTypeError(
            "combinations",
      ...
      e.exports = function (e) {
        ...
        e.min = function (e) {
          if (0 == arguments.length)
            throw new SyntaxError(
              "Function min requires one or more parameters (0 provided)"
            );
          if (o(e)) {
            if (1 == arguments.length) return n(e);
            if (2 == arguments.length)
              return i.reduce(arguments[0], arguments[1], r);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.max = function (e) {
          if (0 == arguments.length)
            throw new SyntaxError(
              "Function max requires one or more parameters (0 provided)"
            );
          if (o(e)) {
            if (1 == arguments.length) return n(e);
            if (2 == arguments.length)
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.mean = function (e) {
          if (0 == arguments.length)
            throw new SyntaxError(
              "Function mean requires one or more parameters (0 provided)"
            );
          if (o(e)) {
            if (1 == arguments.length) return n(e);
      ...
      e.exports = function (e) {
        function r(r) {
          ...
          if (o % 2 == 0) {
            var s = t[o / 2 - 1],
              f = t[o / 2];
            if (!(a(s) || s instanceof i || s instanceof n))
              throw new e.error.UnsupportedTypeError("median", e["typeof"](s));
            if (!(a(f) || f instanceof i || f instanceof n))
              throw new e.error.UnsupportedTypeError("median", e["typeof"](f));
            return e.divide(e.add(s, f), 2);
          }
          var c = t[(o - 1) / 2];
          if (!(a(c) || c instanceof i || c instanceof n))
            throw new e.error.UnsupportedTypeError("median", e["typeof"](c));
          return c;
        }
        var n = (t(9), t(10)),
          i = e.type.BigNumber,
        ...
        e.median = function (e) {
          if (0 == arguments.length)
            throw new SyntaxError(
              "Function median requires one or more parameters (0 provided)"
            );
          if (s(e)) {
            if (1 == arguments.length) return r(e.valueOf());
            throw 2 == arguments.length
              ? new Error("median(A, dim) is not yet supported")
              : new SyntaxError("Wrong number of parameters");
          }
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.prod = function (e) {
          if (0 == arguments.length)
            throw new SyntaxError(
              "Function prod requires one or more parameters (0 provided)"
            );
          if (i(e)) {
            if (1 == arguments.length) return r(e);
            throw 2 == arguments.length
              ? new Error("prod(A, dim) is not yet supported")
              : new SyntaxError("Wrong number of parameters");
          }
          return r(arguments);
        };
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.sum = function (e) {
          if (0 == arguments.length)
            throw new SyntaxError(
              "Function sum requires one or more parameters (0 provided)"
            );
          if (i(e)) {
            if (1 == arguments.length) return r(e);
            throw 2 == arguments.length
              ? new Error("sum(A, dim) is not yet supported")
              : new SyntaxError("Wrong number of parameters");
          }
          return r(arguments);
        };
        ...
        e.atan = function c(r) {
          ...
          if (u(r)) {
            var t = r.re,
              ...
              h = e.log(m);
            return new i(-0.5 * h.im, 0.5 * h.re);
          }
          if (f(r)) return o.deepMap(r, c);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.atan2 = function f(r, t) {
          ...
          if (s(r) || null === r) return f(+r, t);
          if (s(t) || null === t) return f(r, +t);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.cos = function p(r) {
          ...
          if (f(r))
            return new i(
              0.5 * Math.cos(r.re) * (Math.exp(-r.im) + Math.exp(r.im)),
              0.5 * Math.sin(r.re) * (Math.exp(-r.im) - Math.exp(r.im))
            );
          if (c(r)) {
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.cosh = function p(r) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("cosh", arguments.length, 1);
      ...
      e.exports = function (e) {
        ...
        e.cot = function p(r) {
          ...
          if (f(r)) {
            var t =
              Math.exp(-4 * r.im) -
              2 * Math.exp(-2 * r.im) * Math.cos(2 * r.re) +
              1;
            return new i(
              (2 * Math.exp(-2 * r.im) * Math.sin(2 * r.re)) / t,
              (Math.exp(-4 * r.im) - 1) / t
            );
          }
          if (c(r)) {
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.coth = function p(r) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("coth", arguments.length, 1);
          if (s(r)) {
            var t = Math.exp(2 * r);
            return (t + 1) / (t - 1);
          }
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.csc = function p(r) {
          ...
          if (f(r)) {
            var t =
              0.25 * (Math.exp(-2 * r.im) + Math.exp(2 * r.im)) -
              0.5 * Math.cos(2 * r.re);
            return new i(
              (0.5 * Math.sin(r.re) * (Math.exp(-r.im) + Math.exp(r.im))) / t,
              (0.5 * Math.cos(r.re) * (Math.exp(-r.im) - Math.exp(r.im))) / t
            );
          }
          if (c(r)) {
            if (!r.hasBase(o.BASE_UNITS.ANGLE))
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.csch = function m(r) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("csch", arguments.length, 1);
          if (u(r))
            return 0 == r
              ? Number.NaN
              : Math.abs(2 / (Math.exp(r) - Math.exp(-r))) * s.sign(r);
          if (c(r)) {
            var t = Math.exp(r.re),
              h = Math.exp(-r.re),
              g = Math.cos(r.im) * (t - h),
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.sech = function p(r) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("sech", arguments.length, 1);
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.sinh = function p(r) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("sinh", arguments.length, 1);
          if (s(r)) return (Math.exp(r) - Math.exp(-r)) / 2;
          if (f(r)) {
            var t = Math.cos(r.im),
              m = Math.sin(r.im),
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.tanh = function p(r) {
          if (1 != arguments.length)
            throw new e.error.ArgumentsError("tanh", arguments.length, 1);
          if (s(r)) {
            var t = Math.exp(2 * r);
            return (t - 1) / (t + 1);
          }
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.filter = function (t, i) {
          if (2 !== arguments.length)
            throw new e.error.ArgumentsError("filter", arguments.length, 2);
          if (t instanceof n) {
            var o = t.size();
            if (o.length > 1)
              throw new Error("Only one dimensional matrices supported");
            return new n(r(t.toArray(), i));
          }
    ...
    function (e, r, t) {
      ...
      e.exports = function (e) {
        function r(r, t, n) {
          (n.override || void 0 === e[r]) &&
            ((e[r] =
              n.wrap && "function" == typeof t
                ? function () {
                ...
                : t),
            e.chaining.Selector.createProxy(r, t));
        }
        function n(e) {
        ...
        e["import"] = function l(i, o) {
          ...
          if (1 != a && 2 != a)
            throw new e.error.ArgumentsError("import", a, 1, 2);
          var s,
            f = {
      ...
      e.exports = function (e) {
        ...
        e.map = function (t, i) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError("map", arguments.length, 2);
          if (Array.isArray(t)) return r(t, i);
          if (t instanceof n) return t.map(i);
          throw new e.error.UnsupportedTypeError("map", e["typeof"](t));
        };
      };
    },
    function (e, r, t) {
      ...
      e.exports = function (e) {
        ...
        e.print = function (r, t, i) {
          ...
          if (!n(r))
            throw new TypeError(
              "String expected as first parameter in function format"
            );
          if (!(t instanceof Object))
            throw new TypeError(
              "Object expected as second parameter in function format"
            );
          return r.replace(/\$([\w\.]+)/g, function (r, o) {
            for (
              var a = o.split("."), s = t[a.shift()];
              a.length && void 0 !== s;
      ...
      e.exports = function (e) {
        ...
        e.sort = function (t, n) {
          ...
          if (1 === arguments.length) i = e.compare;
            ...
            if (2 !== arguments.length)
              throw new e.error.ArgumentsError("sort", arguments.length, 1, 2);
      ...
      e.exports = function (e) {
        ...
        e.forEach = function (t, i) {
          if (2 != arguments.length)
            throw new e.error.ArgumentsError("forEach", arguments.length, 2);
          if (Array.isArray(t)) return r(t, i);
          if (t instanceof n) return t.forEach(i);
          throw new e.error.UnsupportedTypeError("forEach", e["typeof"](t));
        };
      };
    },
      ...
      (r.isBigNumber = function (e) {
        ...
        (r.format = function (e, t) {
          ...
          switch (
            (void 0 !== t &&
              (t.notation && (n = t.notation),
              i(t) ? (o = t) : t.precision && (o = t.precision)),
            n)
          ) {
            case "fixed":
            ...
            case "auto":
              ...
              t &&
                t.exponential &&
                (void 0 !== t.exponential.lower && (a = t.exponential.lower),
                void 0 !== t.exponential.upper && (s = t.exponential.upper));
              {
                ({
              ...
              return (
                (u =
                  f.gte(a) && f.lt(s)
                    ? e.toSignificantDigits(o).toFixed()
                    : r.toExponential(e, o)),
                u.replace(/((\.\d*?)(0+))($|e)/, function () {
                  var e = arguments[2],
                    r = arguments[4];
                  return "." !== e ? e + r : r;
                })
    ...
    function (e, r, t) {
      ...
      function o(e, t, n, i) {
        var a,
          ...
          f = t[n],
          l = Math.min(u, f);
        if (((e.length = f), n < t.length - 1)) {
          var p = n + 1;
          for (a = 0; l > a; a++)
            (s = e[a]), m(s) || ((s = [s]), (e[a] = s)), o(s, t, p, i);
          for (a = l; f > a; a++) (s = []), (e[a] = s), o(s, t, p, i);
        } else {
      ...
      (r.size = function (e) {
        ...
        (r.resize = function (e, r, t) {
          ...
          r.forEach(function (e) {
            if (!u.isNumber(e) || !u.isInteger(e) || 0 > e)
              throw new TypeError(
                "Invalid size, must contain positive integers (size: " +
                  f.format(r) +
                  ")"
        ...
        (r.squeeze = function (e, t) {
          for (var n = t || r.size(e); m(e) && 1 === e.length; )
            (e = e[0]), n.shift();
        ...
        (r.unsqueeze = function (e, t, n, i) {
          var o = i || r.size(e);
          if (n) for (var a = 0; n > a; a++) (e = [e]), o.unshift(1);
      ...
      !(function (i) {
        ...
        function o(e) {
          for (var r, t, n = 1, i = e.length, o = e[0] + ""; i > n; n++) {
            for (r = e[n] + "", t = T - r.length; t--; ) r = "0" + r;
            o += r;
          }
        ...
        function a(e, r, t, n) {
          ...
          return (
            ...
            0 > a
              ? ((a += T), (i = 0))
              : ((i = Math.ceil((a + 1) / T)), (a %= T)),
            (o = N(10, T - a)),
            (u = e[i] % o | 0),
            null == n
              ? 3 > a
                ? (0 == a ? (u = (u / 100) | 0) : 1 == a && (u = (u / 10) | 0),
                  (s =
                    (4 > t && 99999 == u) ||
                    (t > 3 && 49999 == u) ||
                    5e4 == u ||
                    0 == u))
                : (s =
                    (((4 > t && u + 1 == o) || (t > 3 && u + 1 == o / 2)) &&
                      ((e[i + 1] / o / 100) | 0) == N(10, a - 2) - 1) ||
                    ((u == o / 2 || 0 == u) && 0 == ((e[i + 1] / o / 100) | 0)))
              : 4 > a
              ? (0 == a
                  ? (u = (u / 1e3) | 0)
                  : 1 == a
                  ? (u = (u / 100) | 0)
                  : 2 == a && (u = (u / 10) | 0),
                (s = ((n || 4 > t) && 9999 == u) || (!n && t > 3 && 4999 == u)))
              : (s =
                  (((n || 4 > t) && u + 1 == o) ||
                    (!n && t > 3 && u + 1 == o / 2)) &&
                  ((e[i + 1] / o / 1e3) | 0) == N(10, a - 3) - 1),
            s
          );
        }
        function s(e, r, t) {
          ...
          return null == r ||
            (((x = 0 > r || r > 8) ||
              (0 !== r && (n.errors ? parseInt : parseFloat)(r) != r)) &&
              !p(n, "rounding mode", r, t, 0))
            ? n.rounding
            : 0 | r;
        }
        function u(e, r, t, n) {
          ...
          return (
            (!(x = (n || 0) > r || r >= U + 1) &&
              (0 === r || (i.errors ? parseInt : parseFloat)(r) == r)) ||
            p(i, "argument", r, t, 0)
          );
        }
        function f(e, r) {
          ...
          for (
            null == r ? ((v = !1), (u = x)) : (u = r), c = new h(0.03125);
            e.e > -2;

          )
            (e = e.times(c)), (m += 5);
          for (
            n = ((Math.log(N(2, m)) / Math.LN10) * 2 + 5) | 0,
              u += n,
              t = s = f = new h(d),
              h.precision = u;
            ;
            ...
            if (
              ...
              (t = t.times(++p)),
              (c = f.plus(z(s, t, u, 1))),
              o(c.c).slice(0, u) === o(f.c).slice(0, u))
            ) {
              for (i = m; i--; ) f = g(f.times(f), u, 1);
              if (null != r) return (h.precision = x), f;
              if (!(3 > l && a(f.c, u - n, w, l)))
                return g(f, (h.precision = x), w, (v = !0));
              (h.precision = u += 10), (t = s = c = new h(d)), (p = 0), l++;
            }
            f = c;
          }
        }
        function c(e, r, t, n) {
          var i,
            ...
            u = (e = new s(e)).e;
          if (
            (null == r ? (t = 0) : (g(e, ++r, t), (t = n ? r : r + e.e - u)),
            (u = e.e),
            (i = o(e.c)),
            1 == n || (2 == n && (u >= r || u <= s.toExpNeg)))
          ) {
            for (; i.length < t; i += "0");
            ...
            var o = new Error(
              (n ||
                ...
                ([
                  ...
                  r +
                    ([
                      x ? " out of range" : " not an integer",
                      " not a boolean or binary digit",
                    ][i] || "")) +
                ": " +
                t
            );
            throw ((o.name = "Decimal Error"), (x = b = 0), o);
          }
        }
        function m(e, r, t) {
          var n = new e(e.ONE);
          for (v = !1; 1 & t && (n = n.times(r)), (t >>= 1), t; )
            r = r.times(r);
          return (v = !0), n;
        }
        function h(e, r) {
          var t,
            ...
            A = N.rounding,
            T = N.precision;
          if (b.s < 0 || !E || !E[0] || (!b.e && 1 == E[0] && 1 == E.length))
            return new N(E && !E[0] ? -1 / 0 : 1 != b.s ? 0 / 0 : E ? 0 : b);
          if (
            (null == r ? ((v = !1), (c = T)) : (c = r),
            (N.precision = c += y),
            (t = o(E)),
            ...
            return (
              (b = new N(n + "." + t.slice(1))),
              c + 2 > B.length && p(N, 1, c + 2, "ln"),
              (b = h(b, c - y).plus(new N(B.slice(0, c + 2)).times(s + ""))),
              (N.precision = T),
              null == r ? g(b, T, A, (v = !0)) : b
            );
          for (; (7 > n && 1 != n) || (1 == n && t.charAt(1) > 3); )
            (b = b.times(e)), (t = o(b.c)), (n = t.charAt(0)), x++;
          for (
            s = b.e,
              n > 1
                ? ((b = new N("0." + t)), s++)
                : (b = new N(n + "." + t.slice(1))),
              d = b,
              l = u = b = z(b.minus(M), b.plus(M), c, 1),
              w = g(b.times(b), c, 1),
              i = 3;
            ;
            ...
            if (
              ((u = g(u.times(w), c, 1)),
              (m = l.plus(z(u, new N(i), c, 1))),
              o(m.c).slice(0, c) === o(l.c).slice(0, c))
            ) {
              if (
                ((l = l.times(2)),
                0 !== s &&
                  (c + 2 > B.length && p(N, 1, c + 2, "ln"),
                  (l = l.plus(new N(B.slice(0, c + 2)).times(s + "")))),
                (l = z(l, new N(x), c, 1)),
                null != r)
              )
                return (N.precision = T), l;
              if (!a(l.c, c - y, A, f))
                return g(l, (N.precision = T), A, (v = !0));
              (N.precision = c += y),
                (m = u = b = z(d.minus(M), d.plus(M), c, 1)),
                (w = g(b.times(b), c, 1)),
                (i = f = 1);
            }
            (l = m), (i += 2);
          ...
          e: if (r != o) {
            ...
            if (((o = r - i), 0 > o))
              (o += T),
                ...
                (u = c[(l = 0)]),
                (f = (u / N(10, i - a - 1)) % 10 | 0);
            else if (((l = Math.ceil((o + 1) / T)), l >= c.length)) {
              if (!n) break e;
              for (; c.length <= l; c.push(0));
              (u = f = 0), (i = 1), (o %= T), (a = o - T + 1);
            } else {
              for (u = s = c[l], i = 1; s >= 10; s /= 10, i++);
              (o %= T),
                (a = o - T + i),
                (f = 0 > a ? 0 : E((u / N(10, i - a - 1)) % 10));
            }
            if (
              ((n =
                n ||
            ...
            if (
              (0 == o
                ...
                : ((c.length = l + 1),
                  (s = N(10, T - o)),
                  (c[l] = a > 0 ? ((u / N(10, i - a)) % N(10, a) | 0) * s : 0)),
              n)
            )
              for (;;) {
                if (0 == l) {
        ...
        (O.absoluteValue = O.abs =
          ...
          (O.decimalPlaces = O.dp =
            function () {
              ...
              if ((e = this.c)) {
                if (
                  ((t = ((r = e.length - 1) - E(this.e / T)) * T), (r = e[r]))
                )
                  for (; r % 10 == 0; r /= 10, t--);
                0 > t && (t = 0);
              }
          ...
          (O.dividedToIntegerBy = O.divToInt =
            function (e, r) {
              var t = this,
                n = t.constructor;
              return (
                (b = 18), g(z(t, new n(e, r), 0, 1, 1), n.precision, n.rounding)
              );
            }),
          (O.equals = O.eq =
            function (e, r) {
          ...
          (O.isInteger = O.isInt =
            function () {
              return !!this.c && E(this.e / T) > this.c.length - 2;
            }),
          (O.isNaN = function () {
            return !this.s;
          }),
          ...
          (O.logarithm = O.log =
            function (e, r) {
              ...
              if (
                ((n = d.c),
                d.s < 0 || !n || !n[0] || (!d.e && 1 == n[0] && 1 == n.length))
              )
                return new w(
                  n && !n[0] ? -1 / 0 : 1 != d.s ? 0 / 0 : n ? 0 : 1 / 0
                );
              if (
                ((u =
                  t &&
          ...
          (O.minus = function (e, r) {
            ...
            if (((f = f.slice()), (n = f.length), (u = p - l))) {
              for (
                (o = 0 > u)
                  ? ((u = -u), (t = f), (n = c.length))
                  : ((l = p), (t = c)),
                  (p = Math.ceil(m / T)) > n && (n = p),
                  u > (n += 2) && ((u = n), (t.length = 1)),
                  t.reverse(),
                  r = u;
                r--;
                t.push(0)
              ...
              for ((o = n < (i = c.length)) && (i = n), u = r = 0; i > r; r++)
                if (f[r] != c[r]) {
                  o = f[r] < c[r];
                  break;
                }
            if (
              (o && ((t = f), (f = c), (c = t), (e.s = -e.s)),
              (r = -((i = f.length) - c.length)) > 0)
            )
              for (; r--; f[i++] = 0);
            for (p = A - 1, r = c.length; r > u; ) {
              if (f[--r] < c[r]) {
                for (n = r; n && !f[--n]; f[n] = p);
                --f[n], (f[r] += A);
              }
            ...
            return (e.e = u + l * T - 1), v ? g(e, m, h) : e;
          }),
          (O.modulo = O.mod =
            function (e, r) {
              var t,
              ...
              return (
                ...
                t || !e.c || (i.c && !i.c[0])
                  ? t
                    ? new o(0 / 0)
                    : g(new o(i), o.precision, o.rounding)
                  : ((v = !1),
                    9 == a
                      ? ((e.s = 1),
                        (n = z(i, e, 0, 3, 1)),
          ...
          (O.plus = function (e, r) {
            ...
            if (!f || !u) {
              ...
              if (!a[0] || !s[0])
                return (
                  (n = s[0] ? e : new i(a[0] ? n : 0 * o)), v ? g(n, c, l) : n
                );
            }
            if (((a = a.slice()), (o = f - u))) {
              for (
            ...
            for (
              a.length - s.length < 0 && ((t = s), (s = a), (a = t)),
                o = s.length,
                r = 0,
                f = A;
              o;
            ...
            return (e.e = o + u * T - 1), v ? g(e, c, l) : e;
          }),
          (O.precision = O.sd =
            function (e) {
              var r = null,
              ...
              return (
                e != r &&
                  ...
                  1 !== e &&
                  0 !== e &&
                  p(t.constructor, "argument", e, "precision", 1),
                t.c && ((r = l(t.c)), e && t.e + 1 > r && (r = t.e + 1)),
                r
              );
            }),
          (O.round = function () {
          ...
          (O.squareRoot = O.sqrt =
            function () {
              ...
              for (
                ...
                if (
                  ((a = n),
                  (n = p.times(a.plus(z(s, a, t + 2, 1)))),
                  o(a.c).slice(0, t) === (r = o(n.c)).slice(0, t))
                ) {
                  if (
                    ((r = r.slice(t - 3, t + 1)),
                    "9999" != r && (i || "4999" != r))
          ...
          (O.times = function (e, r) {
            ...
            for (u = r - 1; u > -1; u--) {
              for (r = 0, f = c + u; f > u; r = (r / A) | 0)
                (r = t[f] + s[u] * a[f - u - 1] + r), (t[f--] = r % A | 0);
              r && (t[f] = (t[f] + r) % A);
            }
            for (r && ++n, t[0] || t.shift(), f = t.length; !t[--f]; t.pop());
            for (e.c = t, c = 1, r = t[0]; r >= 10; r /= 10, c++);
            return (e.e = c + n * T - 1), v ? g(e, o.precision, o.rounding) : e;
          }),
          ...
          (O.toExponential = function (e, r) {
            ...
            return t.c
              ? c(
                  t,
                  null != e && u(t, e, "toExponential") ? 0 | e : null,
                  null != e && s(t, r, "toExponential"),
                  1
                )
              : t.toString();
          }),
          (O.toFixed = function (e, r) {
            ...
            return (
              null != e &&
                ((e = u(n, e, (t = "toFixed")) ? n.e + (0 | e) : null),
                (r = s(n, r, t))),
          ...
          (O.toFormat = function (e, r, t) {
            var n = this.toFixed(r).split(".");
            return (
              n[0].replace(/\B(?=(\d{3})+$)/g, null == e ? "," : e + "") +
              (n[1]
                ? "." + (t ? n[1].replace(/\d{5}\B/g, "$&" + t) : n[1])
                : "")
            );
          }),
          (O.toFraction = function (e) {
            ...
            for (
              n = w.e = l(d) - c.e - 1,
                w.c[0] = N(10, (u = n % T) < 0 ? T + u : u),
                (null == e ||
                  ((!((b = 12), (a = new m(e))).s ||
                    (x = a.cmp(h) < 0 || !a.c) ||
                    (m.errors && E(a.e / T) < a.c.length - 1)) &&
                ...
                a = new m(o(d)),
                u = m.precision,
                m.precision = n = d.length * T * 2;
              (f = z(a, w, 0, 1, 1)), (t = r.plus(f.times(g))), 1 != t.cmp(e);

            )
              (r = g),
                (g = t),
                (h = s.plus(f.times((t = h)))),
                (s = t),
                (w = a.minus(f.times((t = w)))),
                (a = t);
            return (
              (t = z(e.minus(r), g, 0, 1, 1)),
              (s = s.plus(t.times(h))),
              (r = r.plus(t.times(g))),
              (s.s = h.s = c.s),
              (i =
                z(h, g, n, 1).minus(c).abs().cmp(z(s, r, n, 1).minus(c).abs()) <
                1
                  ? [h + "", g + ""]
                  : [s + "", r + ""]),
              (v = !0),
          ...
          (O.toNearest = function (e, r) {
            ...
            return (
              (t = new n(t)),
              null == e
                ? ((e = new n(n.ONE)), (r = n.rounding))
                : ((b = 17), (e = new n(e)), (r = s(t, r, "toNearest"))),
              e.c
                ? t.c &&
                  (e.c[0]
                    ? ((v = !1),
                      (t = z(t, e, 0, 4 > r ? [4, 5, 7, 8][r] : r, 1).times(e)),
                      (v = !0),
                      g(t))
                    : (t.c = [(t.e = 0)]))
                : t.s && (e.s && (e.s = t.s), (t = e)),
                    ...
                    if (
                      ...
                      (n =
                        0 != r && isFinite(r)
                          ...
                          : E(
                              p *
                                (Math.log("0." + o(u.c)) / Math.LN10 + u.e + 1)
                            )),
                      n > c.maxE + 1 || n < c.minE - 1)
                    )
                      return new c(n > 0 ? l / 0 : 0);
                    (v = !1),
                      (c.rounding = u.s = 1),
                      (d = Math.min(12, (n + "").length)),
                      (s = f(e.times(h(u, w + d)), w)),
                      (s = g(s, w + 5, 1)),
                      a(s.c, w, x) &&
                        ((n = w + 10),
                        (s = g(f(e.times(h(u, n + d)), n), n + 5, 1)),
                        +o(s.c).slice(w + 1, w + 15) + 1 == 1e14 &&
                          (s = g(s, w + 1, 0))),
                      (s.s = l),
                      (v = !0),
                      (c.rounding = x);
          ...
          (O.toPrecision = function (e, r) {
            var t = this;
            return null != e && u(t, e, "toPrecision", 1) && t.c
              ? c(t, 0 | --e, s(t, r, "toPrecision"), 2)
              : t.toString();
          }),
          ...
          (O.toString = function (e) {
            ...
            if (null === s) t = i.s ? "Infinity" : "NaN";
              ...
              if (e === r && (s <= a.toExpNeg || s >= a.toExpPos))
                return c(i, null, a.rounding, 1);
              if (((t = o(i.c)), 0 > s)) {
                for (; ++s; t = "0" + t);
                t = "0." + t;
              } else if (((n = t.length), s > 0))
                if (++s > n) for (s -= n; s--; t += "0");
                else n > s && (t = t.slice(0, s) + "." + t.slice(s));
              else if (((r = t.charAt(0)), n > 1)) t = r + "." + t.slice(1);
              else if ("0" == r) return r;
              if (null != e)
                if ((x = !(e >= 2 && 65 > e)) || (e != (0 | e) && a.errors))
                  p(a, "base", e, "toString", 0);
          ...
          (d = (function () {
            function e(e, r, t) {
              for (var n, i, o = [0], a = 0, s = e.length; s > a; ) {
                ...
                for (o[(n = 0)] += S.indexOf(e.charAt(a++)); n < o.length; n++)
                  o[n] > t - 1 &&
                    (null == o[n + 1] && (o[n + 1] = 0),
                    (o[n + 1] += (o[n] / t) | 0),
                    (o[n] %= t));
            ...
            return function (r, t, n, i, o) {
              var a,
                ...
                g = r.rounding;
              for (
                37 > i && (t = t.toLowerCase()),
                  p >= 0 &&
                    ((t = t.replace(".", "")),
                    (l = new r(i)),
                    (f = m(r, l, t.length - p)),
                    (l.c = e(f.toFixed(), 10, n)),
                    (l.e = l.c.length)),
                  c = e(t, i, n),
                  a = s = c.length;
                0 == c[--s];
              ...
              if (
                ...
                for (c.length = h, --n; ++c[--h] > n; )
                  (c[h] = 0), h || (++a, c.unshift(1));
              else c.length = h;
              for (s = c.length; !c[--s]; );
              for (p = 0, t = ""; s >= p; t += S.charAt(c[p++]));
              if (0 > a) {
                for (; ++a; t = "0" + t);
                t = "0." + t;
              } else if (((p = t.length), ++a > p)) for (a -= p; a--; t += "0");
        ...
        var z = (function () {
          ...
          return function (n, i, o, a, s, u) {
                    ...
                    0 > f
                      ? ((N = v[0]),
                        ...
                        -1 == f &&
                          ((b = v.length),
                          (f = r(_, v, U, b)),
                          1 > f && (h++, t(v, b > U ? q : _, b, u))),
                        (b = v.length))
                      : 0 === f && (h++, (v = [0])),
                    (y[l++] = h),
                    f && v[0] ? (v[b++] = I[S] || 0) : ((v = [I[S]]), (b = 1));
                while ((S++ < O || null != v[0]) && z--);
                m = null != v[0];
              }
              y[0] || y.shift();
            }
            if (1 == p) (x.e = c), (x.r = +m);
              ...
              for (l = 1, z = y[0]; z >= 10; z /= 10, l++);
              (x.e = l + c * p - 1), g(x, s ? o + x.e + 1 : o, a, m);
            }
            return x;
          };
        })();
        (w = (function () {
          function e(e) {
            ...
            return e == t ||
              ("object" != typeof e && !p(i, "object expected", e, o))
              ? i
              : ((n = e[(r = "precision")]) != t &&
                  ((x = 1 > n || n > U) || a(n) != n
                    ? p(i, r, n, o, 0)
          ...
          function i(e, r, t) {
            var n,
              ...
              o = 0;
            for (
              "[object Array]" == M.call(r[0]) && (r = r[0]), n = new e(r[0]);
              ++o < r.length;
          ...
          function f(e) {
            var r,
              ...
              s = new a(a.ONE);
            if (
              (null != e && u(s, e, "random") ? (e |= 0) : (e = a.precision),
              (t = Math.ceil(e / T)),
              a.crypto)
            )
              if (y && y.getRandomValues)
                for (r = y.getRandomValues(new Uint32Array(t)); t > i; )
                  (n = r[i]),
                    n >= 429e7
                      ? (r[i] = y.getRandomValues(new Uint32Array(1))[0])
                      : (o[i++] = n % 1e7);
              else if (y && y.randomBytes) {
                for (r = y.randomBytes((t *= 4)); t > i; )
                  (n =
                    r[i] +
                    (r[i + 1] << 8) +
                    (r[i + 2] << 16) +
                    ((127 & r[i + 3]) << 24)),
                    n >= 214e7
                      ? y.randomBytes(4).copy(r, i)
                      : (o.push(n % 1e7), (i += 4));
                i = t / 4;
              } else p(a, "crypto unavailable", y, "random");
            if (!i) for (; t > i; ) o[i++] = (1e7 * Math.random()) | 0;
            for (
              t = o[--i],
                e %= T,
                t && e && ((n = N(10, T - e)), (o[i] = ((t / n) | 0) * n));
              0 === o[i];
              i--
            )
              o.pop();
          ...
          function l(i) {
            function u(e, r) {
              var t = this;
              if (!(t instanceof u))
                return p(u, "Decimal called without new", e), new u(e, r);
              if (e instanceof u) {
                if (null == r)
                  return (
                    (b = 0),
                    ...
                    (t.s = e.s),
                    (t.e = e.e),
                    void (t.c = (e = e.c) ? e.slice() : e)
                  );
                if (10 == r) return g(new u(e), u.precision, u.rounding);
                e += "";
              }
              return m((t.constructor = u), t, e, r);
            }
            return (
              (u.precision = 20),
              (u.rounding = 4),
            ...
            return function (t, n, i, o) {
                ...
                if (
                  ...
                  (n.s =
                    "-" == i.charAt(0)
                      ...
                      : 1),
                  o != s
                    ? (o != (0 | o) && t.errors) || (x = !(o >= 2 && 65 > o))
                      ? (p(t, "base", o, 0, 0), (l = e.test(i)))
                      : ((a = "[" + S.slice(0, (o = 0 | o)) + "]+"),
                  ...
                  return (
                    (n.c = n.e = null),
                    "Infinity" != i &&
                      ("NaN" != i && p(t, "not a number", c), (n.s = null)),
                    (b = 0),
                    n
                  );
              }
              ...
              if ((i = i.slice(u, o + 1))) {
                if (
                  ...
                  for (u && n.c.push(+i.slice(0, u)), o -= T; o > u; )
                    n.c.push(+i.slice(u, (u += T)));
                  (i = i.slice(u)), (u = T - i.length);
                } else u -= o;
                for (; u--; i += "0");
                n.c.push(+i),
                  v &&
    ...
    function (e) {
      ...
      function r(e) {
        ...
        (this.fn = e),
          ...
          (this.message = e
            ? 0 == this.types.length
              ? "Unsupported type of argument in function " + e
              : "Function " +
                e +
                "(" +
                this.types.join(", ") +
                ") not supported"
            : "Unsupported type of argument"),
          (this.stack = new Error().stack);
      }
      (r.prototype = new TypeError()),
        (r.prototype.constructor = TypeError),
        (r.prototype.name = "UnsupportedTypeError"),
        (e.exports = r);
    },
    function (e, r, t) {
      "use strict";
    ...
    function (e, r, t) {
      ...
      function n(e) {
        ...
        if (((this.nodes = e || []), !a(this.nodes) || !this.nodes.every(s)))
          throw new TypeError("Array containing Nodes expected");
      }
      var i = t(160),
        o = (t(3), t(163)),
        a = (t(13), t(147), Array.isArray),
        s = i.isNode;
      (n.prototype = new i()),
        ...
        (n.prototype.map = function (e) {
          for (var r = [], t = 0; t < this.nodes.length; t++)
            r[t] = this._ifNode(e(this.nodes[t], "nodes[" + t + "]", this));
          return new n(r);
        }),
        (n.prototype.clone = function () {
    ...
    function (e, r, t) {
      ...
      var i = t(160),
        ...
        u = t(163).isString;
      (n.prototype = new i()),
        (n.prototype.type = "AssignmentNode"),
        (n.prototype._compile = function (e) {
        ...
        (n.prototype.toTex = function () {
          var e;
          return (
            this.expr instanceof o && (e = ["\\mathbf{", "}"]),
            s.addBraces(s.toSymbol(this.name), e) +
              "=" +
              s.addBraces(this.expr.toTex())
          );
        }),
        (e.exports = n);
    },
    ...
    function (e, r, t) {
      ...
      var i = t(160),
        ...
        c = f.string.isString,
        l = f.number.isNumber,
        p = f["boolean"].isBoolean;
      (n.prototype = new i()),
        (n.prototype.type = "ConditionalNode"),
        (n.prototype._compile = function (e) {
          return (
            (e.testCondition = function (r) {
              ...
              throw new TypeError(
                'Unsupported type of condition "' + e.math["typeof"](r) + '"'
              );
            }),
            "testCondition(" +
        ...
        (n.prototype.toTex = function () {
          var e =
            o.addBraces(this.trueExpr.toTex()) +
            ", &\\quad" +
            o.addBraces("\\text{if}\\;" + this.condition.toTex()) +
            "\\\\" +
            (o.addBraces(this.falseExpr.toTex()) +
              ", &\\quad" +
              o.addBraces("\\text{otherwise}"));
          return o.addBraces(e, [
    ...
    function (e, r, t) {
      ...
      var i = t(160),
        o = (t(142), t(183).type),
        a = t(163).isString,
        s = { number: !0, string: !0, boolean: !0, undefined: !0, null: !0 };
      (n.prototype = new i()),
        (n.prototype.type = "ConstantNode"),
        (n.prototype._compile = function (e) {
          switch (this.valueType) {
            case "number":
              return "bignumber" === e.math.config().number
                ? 'math.bignumber("' + this.value + '")'
                : this.value.replace(/^(0*)[0-9]/, function (e, r) {
      ...
      (n.prototype = new i()),
        ...
        (n.prototype._compile = function (e) {
          return (
            'scope["' +
            this.name +
            '"] =   (function (scope) {    scope = Object.create(scope);     var fn = function ' +
            this.name +
            "(" +
            this.params.join(",") +
            ") {      if (arguments.length != " +
        ...
        (n.prototype.toTex = function () {
          return (
            this.name +
            a.addBraces(this.params.map(a.toSymbol).join(", "), !0) +
            "=" +
            a.addBraces(this.expr.toTex())
          );
        }),
        (e.exports = n);
    },
      ...
      (n.prototype = new i()),
        ...
        (n.prototype.compileSubset = function (e, r) {
          ...
          e.range = function (e, r, t) {
            return new u(
              e instanceof s ? e.toNumber() : e,
              r instanceof s ? r.toNumber() : r,
              t instanceof s ? t.toNumber() : t
            );
          };
          var f = this.ranges.map(function (r, t) {
            var n = i[t];
            return r instanceof o
              ? n
                ? '(function (scope) {  scope = Object.create(scope);   scope["end"] = size[' +
                  t +
                  "];  return range(    " +
                  r.start._compile(e) +
                  ",     " +
        ...
        (n.prototype.forEach = function (e) {
          ...
          for (var r = 0; r < this.ranges.length; r++)
            e(this.ranges[r], "ranges[" + r + "]", this);
        }),
        (n.prototype.map = function (e) {
          for (
            var r = this._ifNode(e(this.object, "object", this)), t = [], i = 0;
            i < this.ranges.length;
            i++
          )
            t[i] = this._ifNode(e(this.ranges[i], "ranges[" + i + "]", this));
          return new n(r, t);
        }),
    ...
    function (e, r, t) {
      ...
      (n.prototype = new i()),
        ...
        (n.prototype.map = function (e) {
          for (var r = [], t = 0; t < this.args.length; t++)
            r[t] = this._ifNode(e(this.args[t], "args[" + t + "]", this));
        ...
        (n.prototype.toString = function () {
          ...
          switch (e.length) {
            case 1:
              return "-" == this.op
                ? "-" + e[0].toString()
                : e[0].toString() + this.op;
            case 2:
              var r = e[0].toString();
              e[0] instanceof n && (r = "(" + r + ")");
              var t = e[1].toString();
              return (
                e[1] instanceof n && (t = "(" + t + ")"),
                r + " " + this.op + " " + t
              );
            default:
        ...
        (n.prototype.toTex = function () {
          ...
          switch (e.length) {
            ...
            case 2:
              ...
              switch (this.op) {
                case "/":
                  ...
                  break;
                case "*":
                  t instanceof n && ("+" === t.op || "-" === t.op) && (c = !0),
                    i instanceof n &&
                      ("+" === i.op || "-" === i.op
                        ? (p = !0)
                        : "*" === i.op && (p = !0)),
                    (r =
                      (t instanceof o || t instanceof n) &&
                      (i instanceof o || i instanceof n)
                        ? " \\cdot "
                        : " \\, ");
                  break;
                case "^":
                  t instanceof n || t instanceof s
                    ? (c = !0)
                    : t instanceof a && (c = null);
                  break;
                case "to":
                  l = u.toUnit(l, !0);
              }
            ...
            default:
              return r + "(" + this.args.map(u.toSymbol).join(", ") + ")";
          }
        }),
        (e.exports = n);
    },
    function (e, r, t) {
      ...
      (n.prototype = new i()),
        ...
        (n.prototype._compile = function (e) {
          ...
          if (t) {
            var i;
            do i = "p" + Math.round(1e4 * Math.random());
            while (i in e);
            return (
              (e[i] = this.args),
              '("' +
    ...
    function (e, r, t) {
      ...
      function n(e, r, t) {
        ...
        if (!o(e)) throw new TypeError("Node expected");
        if (!o(r)) throw new TypeError("Node expected");
        if (t && !o(t)) throw new TypeError("Node expected");
      ...
      (n.prototype = new i()),
        ...
        (n.prototype.toString = function () {
          ...
          return (
            this.step && (e += ":" + this.step.toString()),
            (e += ":" + this.end.toString())
          );
        }),
        (n.prototype.toTex = function () {
    ...
    function (e, r, t) {
      ...
      var i = t(160),
        o = t(154);
      (n.prototype = new i()),
        (n.prototype.type = "UpdateNode"),
        (n.prototype._compile = function (e) {
          return (
            'scope["' +
            this.index.objectName() +
            '"] = ' +
            this.index.compileSubset(e, this.expr._compile(e))
          );
        }),
        (n.prototype.forEach = function (e) {
    ...
    function (e, r, t) {
      ...
      (n.prototype.eval = function () {
        throw new Error(
          "Node.eval is deprecated. Use Node.compile(math).eval([scope]) instead."
        );
      }),
        ...
        (n.prototype.compile = function (e) {
          ...
          var r = { math: o(e), _validateScope: i },
            t = this._compile(r),
            ...
            var t = {
                random: function (r, t, i) {
                  ...
                  if (
                    ...
                    return s instanceof n ? new n(l) : l;
                  }
                  return o(f, c);
                },
                randomInt: function (r, t, i) {
                  ...
                  if (
                    ...
                    return o instanceof n ? new n(l) : l;
                  }
                  return s(f, c);
                },
              ...
              u = function (e, r, t, n) {
                ...
                else for (o = 0, i = e.shift(); i > o; o++) a.push(n(r, t));
                return a;
              };
            return t;
          })(o);
    ...
    function (e, r, t) {
      ...
      function n() {
        for (
          var e, r = Array.prototype.slice.call(arguments), t = 0, n = r.length;
          n > t;
          t++
        ) {
          e = r[t];
          for (var i in e) e.hasOwnProperty(i) && (w[i] = e[i]);
        }
      }
      function i(e, r) {
      ...
      function a(e) {
        return function (t) {
          if ("boolean" == typeof e[t])
            ...
            -1 !== n &&
              (t =
                r.toSymbol(t.substring(0, n)) +
                "_{" +
                r.toSymbol(t.substring(n + 1)) +
                "}");
          }
          return t;
        };
      ...
      var s = t(148),
        ...
        c = { dots: !0, ldots: !0, cdots: !0, vdots: !0, ddots: !0, idots: !0 },
        l = { true: "\\mathrm{True}", false: "\\mathrm{False}" },
        p = {
          inf: "\\infty",
          Inf: "\\infty",
          infinity: "\\infty",
      ...
      n(m, h, f, c, l, p),
        ...
        (r.isFunction = o(m)),
        (r.toFunction = a(m)),
        (r.isCurlyFunction = o(h)),
        (r.toCurlyFunction = a(h)),
        (r.isOperator = o(g)),
        (r.toOperator = a(g)),
        (r.isUnit = o(d)),
        (r.toUnit = (function () {
        ...
        (r.addBraces = function (e, r, t) {
          ...
          switch (
            ...
            "undefined" == typeof r || r === !1
              ...
              : r === !0
              ? ((n = ["(", ")"]), (t = "lr"))
              : (n = Array.isArray(r) && 2 === r.length ? r : [r, r]),
            t)
          ) {
            case "normal":
            case !1:
        ...
        (r.toArgs = function (e) {
          ...
          switch (t) {
            ...
            case "round":
              (a = ["\\lfloor", "\\rceil"]),
                (f = "lr"),
                2 === n.length &&
                  ((p = "_" + r.addBraces(n[1].toTex())), (n = [n[0]]));
              break;
            case "inv":
              p = "^{-1}";
              break;
            ...
            case "eye":
              ...
              break;
            case "det":
              if (e.args[0] instanceof s) return e.args[0].toTex("vmatrix");
              (a = "vmatrix"), (f = "be");
              break;
            default:
              c = !0;
          ...
          return (
            null !== m
              ? ((a = "+" === m || "-" === m), (o = new u(m, t, n).toTex()))
              : (m = ", "),
            null !== a || r.isCurlyFunction(t) || (a = !0),
            (o =
              o ||
              n
                .map(function (e) {
